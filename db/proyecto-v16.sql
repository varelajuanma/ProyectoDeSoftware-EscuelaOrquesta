...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2019 a las 23:04:58
...
(1, 'Pablito', 'Lezcano', '2019-11-05', 1, 'calle falsa 123', 1, 1, 34324, '234324');
...
INSERT INTO `estudiante` (`id`, `apellido`, `nombre`, `fecha_nac`, `lugarnac`, `localidad_id`, `nivel_id`, `domicilio`, `genero_id`, `escuela_id`, `tipo_doc_id`, `numero`, `responsable_id`, `tel`, `barrio_id`) VALUES
(6, 'Gomez', 'Oscar', '1111-11-11', 'china', 1, 1, 'calle falsa 123', 1, 1, 1, 212123, 0, '12121', 1),
(7, 'Barreda', 'Cacho', '1111-11-11', 'berlin', 4, 8, 'calle falsa 123', 2, 17, 2, 13123, 0, '131231', 2),
(9, 'Guzman', 'Pablito', '1111-11-11', 'moscu', 2, 1, 'calle falsa 123', 2, 1, 1, 2121, 0, '21221', 2);
...
(19, 'PreceptorNombre', 'PreceptorApellido', 'preceptor@preceptor.com', 'preceptor', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 1);
